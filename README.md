...
#Стоит отметить, что фоновая музыка в приложении отключена по умолчанию, поэтому вам следует посетить вкладку Settings  и включить звук для более полного экспириенса.
